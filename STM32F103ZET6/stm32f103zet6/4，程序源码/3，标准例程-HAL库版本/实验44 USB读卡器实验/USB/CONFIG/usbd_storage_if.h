...
#ifndef STORAGE_LUN_NBR	 
	#define STORAGE_LUN_NBR 2 //定义USB数量，现修改成2个
#endif
extern long long Mass_Memory_Size[STORAGE_LUN_NBR];
extern u32 Mass_Block_Size[STORAGE_LUN_NBR];
extern u32 Mass_Block_Count[STORAGE_LUN_NBR];
