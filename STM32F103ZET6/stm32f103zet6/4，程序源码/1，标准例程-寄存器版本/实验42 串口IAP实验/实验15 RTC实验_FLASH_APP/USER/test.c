...
{		
	...
	LCD_ShowString(30,162,200,16,16,"  :  :  ");	 		    
	while(1)
	{								    
		if(t!=calendar.sec)
		{
			...
			LCD_ShowNum(30,162,calendar.hour,2,16);									  
			LCD_ShowNum(54,162,calendar.min,2,16);									  
			LCD_ShowNum(78,162,calendar.sec,2,16);
			LED0=!LED0;
		}	
		delay_ms(10);								  
	};  
